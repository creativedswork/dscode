...
Session permission persistence: store and restore pending tool permission state when sessions are interrupted mid-prompt. Ensures users can switch sessions without losing permission context.
