# od-daemon-lifecycle Specification
...
Open Design daemon command resolution SHALL live in the Open Design integration and remain isolated from generic ServiceSupervisor and `src/bootstrap/cli-main.ts`.
