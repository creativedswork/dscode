...
The system SHALL resize images to a unified height of 480 pixels, maintaining original aspect ratio for width.
...
The system SHALL store compressed images in `~/.dscode/data/images/` with content-addressed filenames.
