...
- **Session 00MRIZMZQJ**: 标准案例 — `docs/prototypes/archive/2026-07-14-fix-explore-prototype-html/mcp-toolcard-execution-view-prototype.html` 的生成→迭代→捕获流程
...
|---|---|---|
| `docs/prototypes/archive/2026-07-14-fix-explore-prototype-html/mcp-toolcard-execution-view-prototype.html` | `archive` | 作为 HTML 原型生成、视觉迭代和决策捕获工作流的可执行标准案例保留。 |
