...
Defines the resizable behavior for detail panels (Sessions, MCP, Skills, Settings) that expand between the sidebar and main content area. Reuses the existing `useResizablePanel` hook.
